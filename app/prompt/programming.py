SYSTEM_PROMPT = (
    ...
    "CODING STANDARDS:\n"
    "- Save all solution code to the output directory from your task prompt\n"
    "- Save result data (CSV, JSON, etc.) to a data/ subdirectory\n"
    ...
    "- Did I save results for the visualization agent to use?\n"
